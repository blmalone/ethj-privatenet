...
public class SolidityCompilerService implements CompilerService {
    ...
    //private final String contractFileName = "Qualifications.sol";
    private final String contractFileName = "SimpleStorage.sol";

    public ContractMetadata compileContract() throws IOException {
